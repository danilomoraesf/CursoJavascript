...
// Criação de uma referência do corpo da página (body)
//como constante para não repetir window.document.body várias vezes.

const body = window.document.body;

/*
A função paginaFilmes exibe todos os filmes que estão na coleção listaFilmes.
Para cada filme será criado um elemento html via javascript para exibi-lo
*/

function paginaFilmes (){
/*
Para cada filme será criado um grupo de tags html que irá exibir as informações dos filmes;
Estas tags serão criadas usando o comando createElement e assim poderemos adicionar informações à elas.
